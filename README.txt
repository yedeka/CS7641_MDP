...
Assignment 4 - MDP (markov Decision Process)

Source Code git repo - https://github.com/yedeka/CS7641_MDP.git
...
7] run the main.py file to run both the Forest Management and Frozen Lake MDP problems.